...
BEGIN
	...
	SELECT FRM.FP_FREIGHT_FORM_ID,
		...
		--FRM.EFFECTIVE_DATE,
		FRM.DEFAULT_CROSSDOCK_PALLET_RATE,
		FRM.DEFAULT_BACKHAUL_PALLET_RATE,
		--CONFIG.SHUTTLE_RATE_PER_MILE,
		--CONFIG.FUEL_SURCHARGE,
		--CONFIG.ESTIMATED_LUMPER_EXPENSE,
		--CONFIG.ESTIMATED_ACCESSORIAL_EXPENSE,
		FRM.DEFAULT_TOOL_COOLER_FREEZER_UPCHARGE,
		FRM.DEFAULT_TOOL_MARGIN_TARGET, 
		FRM.DEFAULT_TOOL_PFF_PFH_UPCHARGE,
		FRM.DEFAULT_TOOL_FUEL_SURCHARGE,

		FRM.UCS_CROSSDOCK_PALLET_RATE,
		FRM.UCS_BACKHAUL_PALLET_RATE,
		--CONFIG.SHUTTLE_RATE_PER_MILE,
		--CONFIG.FUEL_SURCHARGE,
		--CONFIG.ESTIMATED_LUMPER_EXPENSE,
		--CONFIG.ESTIMATED_ACCESSORIAL_EXPENSE,
		FRM.UCS_TOOL_COOLER_FREEZER_UPCHARGE,
		FRM.UCS_TOOL_MARGIN_TARGET, 
		FRM.UCS_TOOL_PFF_PFH_UPCHARGE,
		FRM.UCS_TOOL_FUEL_SURCHARGE,
