...
/****** Object:  StoredProcedure [dbo].[SP_FP_TOOL_VENDOR_WHS_UPDATE_ALL]    Script Date: 9/27/2022 10:44:00 AM ******/
SET ANSI_NULLS ON
GO
...
-- 07/09/2022 - CM  -   Wrapped in try catch and added logic for default configs
...
BEGIN TRY      
	...
	SET CALC_ALL_IN_RATE = (VENDOR.CALC_RATE + (CASE WHEN DESTINATION.SOURCE_SYSTEM <> 'UCS' THEN FORM.DEFAULT_TOOL_FUEL_SURCHARGE ELSE FORM.UCS_TOOL_FUEL_SURCHARGE END * CASE WHEN VENDOR.FP_FF_METHOD_ID = 1
																								THEN 0
	...
	SELECT  --EAST_BLENDED_FREIGHT_RATE
			...
			WHERE FORM.FP_FREIGHT_FORM_ID = @FORM_ID
				AND (WHS.SOURCE_SYSTEM='UBS' OR VENDOR.USE_EAST_BLENDED_FREIGHT_RATE = 1)
				AND VENDOR.FP_FF_METHOD_ID <> 4 --VSP
