...
(
	[FP_FREIGHT_FORM_VENDOR_LOG_ID] [bigint] IDENTITY(1,1) NOT FOR REPLICATION NOT NULL,
	...
	[USE_EAST_BLENDED_FREIGHT_RATE] [bit] NULL,
	[AVERAGE_PO_CUBES] [decimal](18, 3) NULL,
 CONSTRAINT [PK_FP_FREIGHT_FORM_VENDOR_LOG] PRIMARY KEY CLUSTERED 
(
	[FP_FREIGHT_FORM_VENDOR_LOG_ID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO

ALTER TABLE [dbo].[FP_FREIGHT_FORM_VENDOR_LOG]  WITH CHECK ADD  CONSTRAINT [FK_FP_FREIGHT_FORM_VENDOR_LOG_FP_FREIGHT_FORM_log] FOREIGN KEY([FP_FREIGHT_FORM_ID])
REFERENCES [dbo].[FP_FREIGHT_FORM] ([FP_FREIGHT_FORM_ID])
GO

ALTER TABLE [dbo].[FP_FREIGHT_FORM_VENDOR_LOG] CHECK CONSTRAINT [FK_FP_FREIGHT_FORM_VENDOR_LOG_FP_FREIGHT_FORM_log]
GO

ALTER TABLE [dbo].[FP_FREIGHT_FORM_VENDOR_LOG]  WITH CHECK ADD  CONSTRAINT [FK_FP_FREIGHT_FORM_VENDOR_LOG_VENDOR_ID] FOREIGN KEY([FP_FREIGHT_FORM_VENDOR_ID])
REFERENCES [dbo].[FP_FREIGHT_FORM_VENDOR] ([FP_FREIGHT_FORM_VENDOR_ID])
GO

ALTER TABLE [dbo].[FP_FREIGHT_FORM_VENDOR_LOG] CHECK CONSTRAINT [FK_FP_FREIGHT_FORM_VENDOR_LOG_VENDOR_ID]
GO