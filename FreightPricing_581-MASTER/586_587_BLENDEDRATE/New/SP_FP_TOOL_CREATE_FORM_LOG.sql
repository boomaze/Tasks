...
BEGIN  
 ...
 INSERT INTO FP_FREIGHT_FORM_LOG (FP_FREIGHT_FORM_ID, FP_FF_TYPE_ID, SUBMIT_DATE, TMS_STATUS_ID, MARGIN_TARGET,   
		 ...
		 EAST_BLENDED_FREIGHT_RATE, GILROC_BLENDED_FREIGHT_RATE, HARCAR_BLENDED_FREIGHT_RATE, STKSGM_BLENDED_FREIGHT_RATE, ANNSER_BLENDED_FREIGHT_RATE, NEXT_STAGE_COMMENT,
 ...
 SELECT  FORM.FP_FREIGHT_FORM_ID, FORM.FP_FF_TYPE_ID, FORM.SUBMIT_DATE, FORM.TMS_STATUS_ID, FORM.MARGIN_TARGET,   
		...
		FORM.EAST_BLENDED_FREIGHT_RATE, FORM.GILROC_BLENDED_FREIGHT_RATE, FORM.HARCAR_BLENDED_FREIGHT_RATE, FORM.STKSGM_BLENDED_FREIGHT_RATE, FORM.ANNSER_BLENDED_FREIGHT_RATE, @NEXT_STAGE_COMMENT,
 ...
 INSERT INTO FP_FREIGHT_FORM_VENDOR_LOG (FP_FREIGHT_FORM_VENDOR_ID, FP_FREIGHT_FORM_ID, TMS_VENDOR_ID,   
    ...
    PROJECTED_LOAD_WEIGHT, USE_EAST_BLENDED_FREIGHT_RATE, PROPOSED_ALLOWANCE_PER_LB, PROPOSED_FREIGHT_PER_LB,   
    ...
    LANDED_EXPENSE_PER_LB, CALC_RATE, CALC_ALL_IN_RATE, CREATED_DATE, CREATED_BY, EFFECTIVE_DATE, PROCESSED_FLAG, CURRENT_EXPENSE, AVERAGE_PO_CUBES)  
 SELECT  VEN_WHS.FP_FREIGHT_FORM_VENDOR_ID, VEN_WHS.FP_FREIGHT_FORM_ID, VEN_WHS.TMS_VENDOR_ID,   
   ...
   VEN_WHS.PROJECTED_LOAD_WEIGHT, VEN_WHS.USE_EAST_BLENDED_FREIGHT_RATE,
   ...
   GETDATE(), @USER_ID, VEN_WHS.EFFECTIVE_DATE, VEN_WHS.PROCESSED_FLAG, VEN_WHS.CURRENT_EXPENSE ,AVERAGE_PO_CUBES
