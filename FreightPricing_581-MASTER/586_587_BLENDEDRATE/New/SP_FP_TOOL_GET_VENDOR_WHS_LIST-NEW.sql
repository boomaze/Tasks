...
/****** Object:  StoredProcedure [dbo].[SP_FP_TOOL_GET_VENDOR_WHS_LIST]    Script Date: 9/26/2022 11:58:43 AM ******/
SET ANSI_NULLS ON
GO
...
CAST(CASE 
 WHEN DEST_WHS.TMS_WHS_ID IN (1, 114) THEN FRM.GILROC_BLENDED_FREIGHT_RATE
 WHEN DEST_WHS.TMS_WHS_ID IN (168, 169) THEN FRM.HARCAR_BLENDED_FREIGHT_RATE
 WHEN DEST_WHS.TMS_WHS_ID IN (160, 214) THEN FRM.STKSGM_BLENDED_FREIGHT_RATE
 WHEN DEST_WHS.TMS_WHS_ID IN (178, 186) THEN FRM.ANNSER_BLENDED_FREIGHT_RATE
ELSE NULL
END AS DECIMAL) AS BLENDED_RATE,

CAST(CASE 
WHEN DEST_WHS.TMS_WHS_ID IN (1, 114) THEN 1
WHEN DEST_WHS.TMS_WHS_ID IN (168, 169) THEN 2
WHEN DEST_WHS.TMS_WHS_ID IN (160, 214) THEN 3
WHEN DEST_WHS.TMS_WHS_ID IN (178, 186) THEN 4
ELSE 0
END AS INT) AS BLENDED_RATE_CODE,
99.070 AS AVG_PO_CUBES,
