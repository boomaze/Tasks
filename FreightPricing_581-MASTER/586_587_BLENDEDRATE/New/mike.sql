...
/****** Object:  StoredProcedure [dbo].[SP_FP_TOOL_GET_VENDOR_WHS_LIST]    Script Date: 9/23/2022 3:39:04 PM ******/
SET ANSI_NULLS ON
GO
...
((FRM_VEN.AVERAGE_PO_WEIGHT * FRM_VEN.TOTAL_POS) + (ISNULL(LINKED_VENDOR_FORMS.AVG_PO_WEIGHT,0)))/(FRM_VEN.TOTAL_POS + ISNULL(LINKED_VENDOR_FORMS.TOTAL_POS,0)) AS AVERAGE_PO_WEIGHT,
((FRM_VEN.AVERAGE_PO_UNITS * FRM_VEN.TOTAL_POS) + (ISNULL(LINKED_VENDOR_FORMS.AVG_PO_CASES,0)))/(FRM_VEN.TOTAL_POS + ISNULL(LINKED_VENDOR_FORMS.TOTAL_POS,0)) AS AVERAGE_PO_CASES,
((FRM_VEN.AVERAGE_PALLETS_PER_PO * FRM_VEN.TOTAL_POS) + (ISNULL(LINKED_VENDOR_FORMS.AVG_PALLETS_PO,0)))/(FRM_VEN.TOTAL_POS + ISNULL(LINKED_VENDOR_FORMS.TOTAL_POS,0)) AS AVG_PALLETS_PO,
...
FRM_VEN.TOTAL_POS + ISNULL(LINKED_VENDOR_FORMS.TOTAL_POS,0) AS TOTAL_POS,
...
CAST(CASE WHEN DEST_WHS.SOURCE_SYSTEM = ''UBS'' THEN 1 ELSE 0 END AS bit) AS LOCKED_EAST_BLENDED_FREIGHT_RATE,
...
LEFT JOIN [dbo].[VIEW_LINKED_VENDOR_FORMS] AS LINKED_VENDOR_FORMS
	ON FRM_VEN.[FP_FREIGHT_FORM_VENDOR_ID] = LINKED_VENDOR_FORMS.MAIN_FORM_ID
