...
BEGIN TRY 
		...
		SELECT * INTO #NOTFULLYBILLED FROM dbo.fnGetPO_NOTFULLYBILLED(@StartDate, @EndDate, 0, NULL)
		...
		INTO #TOTALS FROM [dbo].[fnGetSuppliersPOExpenses](@StartDate,@EndDate, 0, NULL)GROUP BY LO_PURCHASE_ORDER_ID, PO_NUMBER
